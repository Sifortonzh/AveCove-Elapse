<div align="center">
  ...
  <p>
    ...
    <img alt="Version 2.3.3" src="https://img.shields.io/badge/version-2.3.3-b43d35" />
...
| --- | --- | :---: |
| **Question Library** | Multi-bank storage, source/copyright metadata, search, groups, custom ordering, featured papers, seven-day import links, and a batch-upload Pavilion JSON vault | Stable |
...
- **v2.3.3** — Auto-expands and locates the active question in chapter navigation; normalizes `单`/`多` JSON question types to A1/X.
