...
> [!IMPORTANT]
> **当前版本：v2.1.1。** 答题卡现可按每次 5 题批量补录缺失答案；学习笔记可按错题、精选、批注及 AI 原题解析整理为打印版 PDF；选项批注支持直接粘贴或上传图片，并继续随题目记录同步。
...
- **v2.1.1** — 新增答题卡每次 5 题批量补答案、按错题/精选/批注整理的打印版 PDF 笔记，以及选项批注粘贴或上传图片。
