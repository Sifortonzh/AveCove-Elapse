<div align="center">
  ...
  <p>
    ...
    <img alt="版本 2.1.4" src="https://img.shields.io/badge/version-2.1.4-b43d35" />
...
> [!IMPORTANT]
> **当前版本：v2.1.4。** 藏经阁改为从“我的题库”批量上传红豆 JSON；补答案支持任意原题号起步和部分提交；同主键导入可选择完全替换或保留刷题记录；AI 操作文案进一步精简。

## 产品地图

| 模块 | 当前能力 | 阶段 |
| --- | --- | :---: |
| **我的题库** | 多题库保存、来源与版权信息、搜索、分组、自定义排序、精选试卷、7 天导入链接及可批量上传的藏经阁 JSON 仓库 | 稳定 |
...
- 306 工作台以 2017 年标准卷为模板：固定识别 A 型 1–115、B 型 116–135、X 型 136–165，不再保留 C 型空档，并严格要求每题只有 A-D 四个选项。
- B 型题会把一组共用的 A-D 备选项复制到对应的两道子题；解析卷中以绿色标注的正确字母也可确定性提取并按原题号关联。
